<?php
	...
	$kode = $_GET['id'];
	$sql = "SELECT trx.*, tmp_trx.*, barangjasa.*, mekanik.*, kasir.* FROM trx, tmp_trx, barangjasa, mekanik, kasir 
			WHERE trx.id_trx=tmp_trx.id_trx AND trx.id_mek=mekanik.id_mek AND tmp_trx.id_brg=barangjasa.id_brg
...
<table width="100%">
	...
	<tr>
		<td width="20%"><b>Mekanik</b></td>
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $result['nama_mek'];?></td>
	</tr>
	<tr>
