...
<head>
	...
	<title>CV. Honda Kita | <?php echo $pagedesc ?></title>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					...
					<div class="float-right">&nbsp;<strong>CV. Honda Kita</strong></div>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Sistem Informasi Penjualan Suku Cadang & Jasa Service Sepeda Motor</h4>
                        ...
                        <!-- open <li> tag generated with php, see line 155-160 -->
							<a href="#"><i class="fa fa-group fa-fw"></i>&nbsp;Data Mekanik<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
