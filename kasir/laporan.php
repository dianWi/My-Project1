...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Laporan Faktur Jual</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
					...
					<div class="col-lg-12">
						...
						<?php
							if(isset($_GET['submit'])){
								...
								$mulai 	 = $_GET['awal'];
								$selesai = $_GET['akhir'];
								$sql = "SELECT trx.*, mekanik.*, kasir.* FROM trx, mekanik, kasir WHERE
										trx.id_mek=mekanik.id_mek AND trx.id_kasir=kasir.id_kasir AND 
